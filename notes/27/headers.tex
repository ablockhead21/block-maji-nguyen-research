...
\usepackage[pdftex,bookmarks=true,pdfstartview=FitH,colorlinks,linkcolor=blue,filecolor=blue,citecolor=blue,urlcolor=blue,pagebackref=false]{hyperref}
    \urlstyle{sf}
...
%\titlespacing\section{0pt}{2pt plus 0pt minus 0pt}{2pt plus 0pt minus 0pt}
%\titlespacing\subsection{0pt}{2pt plus 0pt minus 0pt}{2pt plus 0pt minus 0pt}
...
%% Marking
\newcommand\TODO[1]{{\color{blue} TODO: {#1}}\xspace}
...
%\DeclareMathOperator*{\argmax}{arg\,max}
  ...
  %% Euscript Alphabet
  \newcommand{\esC}{\ensuremath{\EuScript{C}}\xspace}
  \newcommand{\esS}{\ensuremath{\EuScript{S}}\xspace}
...
% min-entropy
\newcommand{\minentropy}{\ensuremath{\mathbf{H_\infty}}\xspace}

% average min-entropy
\newcommand{\ame} {\ensuremath{\mathbf{\widetilde{H}_\infty}}\xspace}
...
\newcommand{\degD}{\ensuremath{\mathrm{deg}\ D}\xspace}

% inverse command
\newcommand{\inverse}{\ensuremath{^{\text{-}1}}\xspace}

% command for function w_i
\newcommand{\wi}[2]{\ensuremath{w_{#1}\left(#2\right)}\xspace}
\newcommand{\weight}{\pred{wt}}
\newcommand{\bias}[0]{\ensuremath{\pred{Bias}}\xspace}
\newcommand{\binent}{\mathbf{h_2}}
\newcommand{\puncture}{\pred{Puncture}}

%\newcommand{\TODO}[1]{{{\color{red} TODO: #1}}}
%\newcommand{\TODOx}[1]{{{\color{red} #1}}}
%\newcommand{\divya}[1]{{{\color{magenta} Divya TODO: #1}}}
%\newcommand{\dgcomment}[1]{{\color{magenta} DG Comment { #1}}}
%\newcommand{\dg}[1]{{{\color{magenta}  #1}}}
%\newcommand{\hai}[1]{{\color{blue} #1}}
%\newcommand{\alex}[1]{{\color{Green4} #1}}
%\newcommand{\dgnew}[1]{{{\color{blue} NEW: #1}}}
%\newcommand{\oldm}[1]{{{\color{red} OLD: #1}}}
%\newcommand{\remove}[1]{{{\color{red} rm: #1}}}

%% command for natural map
%\newcommand{\nmap}[1]{\ensuremath{\llbracket #1 \rrbracket}\xspace}
%
%% inverse command for natural map
%\newcommand{\nmapi}[1]{\ensuremath{\llparenthesis #1 \rrparenthesis}\xspace}

\newcommand{\teta}{\ensuremath{\widetilde \eta}\xspace}
\newcommand{\tkappa}{\ensuremath{\widetilde \kappa}\xspace}
\newcommand{\wt}[1]{\ensuremath{\pred{wt}\left({#1}\right)}\xspace}
\newcommand{\EX}{\ensuremath{{\bbE}}\xspace}


\newcommand{\etas}{\ensuremath{\eta^*}\xspace}
\newcommand{\sq}{\ensuremath{\sqrt{q}-1}\xspace}

\newcommand{\enc}{\pred{Enc}}
\newcommand{\dec}{\pred{Dec}}
\newcommand{\len}{\ell}
\newcommand{\parity}{\pred{parity}}
...
%% Imported Lemma envorinment
\spnewtheorem{importedtheorem}{Imported Theorem}{\bfseries}{\itshape}
\spnewtheorem{importedlemma}{Imported Lemma}{\bfseries}{\itshape}
