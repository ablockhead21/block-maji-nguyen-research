...
\titleformat*{\paragraph}{\centering \itshape}
\abslabeldelim{.~}
...
\newtheorem{importedlemma}{Imported Lemma}[section]
\newtheorem{importedtheorem}{Imported Theorem}[section]
...
% Command ensures bibliography urls are nice
