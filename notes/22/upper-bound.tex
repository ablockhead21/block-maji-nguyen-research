...
\begin{proof}
	...
	Next we have $ \abs{\bF} = n \cdot m$, and the number of vertices is $ \Theta(n) $. Next, we will so that $ \bF $ contains no triangle. For the sake of contradiction, suppose $ F $ contains a triangle, say
