...
\begin{proof}[of \theoremref{main}]
	...
	\begin{itemize}
		...
		\item By \lemmaref{min-qual-secret}, if $s_{i, x_i}'$ is a valid sharing of $m_0 \xor m_1$ for $i \in [n]$, then reconstruction is exactly $m_0 \xor m_1 = (\xor_{i \in \overline{\cA}} s_{i,x_i}) \xor (\xor_{i \in \cA} s_{i, x_i}' )$.
