...
\subsection{Evidence of Hardness}
...
\begin{itemize}
	...
	\item $\bA$ can be set as a public parameter, so there is no need to sample this matrix or include it in the output.
...
\paragraph{Secret Key Encryption.} t
