...
%% second arrow
\draw[thick, ->] (OLEk) -- (mOLE) node[above, midway, fill opacity=0, text opacity=1] {\footnotesize \OLE[]-Extraction};
...
%% first arrow
\draw[thick, ->] (IP) -- (OLEk) node[above, midway, align=center,fill opacity=0, text opacity=1] {\footnotesize Random-Output\\\footnotesize Correlation Extractor};
