...
\draw (c01) -- (d01) node [midway, above] {$ p(r_A, r_B) $};

\coordinate (temp) at ($0.5*(c10)+0.5*(d10)$);
\node[node distance = 2 cm, below of = temp] {\underline{General Graph}}; 
...
%% IP
%%% First Correlation 
\node [node distance = 1.2cm, right = of r2] {$ \pred{IP} $};

\node [vert, node distance = 1cm, right = of b00] (e00) {00}; 
...
\draw (e00) -- (f00)  (e00) -- (f01)  (e00) -- (f10)  (e00) -- (f11); 
\draw (e01) -- (f00)  (e01) -- (f10); 
\draw (e10) -- (f00)  (e10) -- (f01); 
\draw (e11) -- (f00)  (e11) -- (f11);

\coordinate (temp) at ($0.5*(e11)+0.5*(f11)$);
\node[below of = temp] {\underline{Inner Product}}; 
