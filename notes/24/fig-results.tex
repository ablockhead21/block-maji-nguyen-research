...
%%%
\ifnum\slideno>1
& {\setbeamercolor{footnotemark}{fg=red}\only<2>{\footnote{The inner-product correlation $\IP[\bbF^n]$ is a correlation in which each party gets a vector in $ \bbF^n $ such that the vectors are orthogonal.}}}\IP[\GF{2}^{n}] & $1$ & $(\nicefrac12 - g) n$ & $2^{-gn}$ & 2 \\
\hline
%%%
\ifnum\slideno>2 
