...
\begin{frame}{Our Combinatorial Problem}
	...
	{\setbeamercolor{block title}{bg=Gray, fg=white}
	\begin{block}{Note}
		This problem is a generalization of the 3-free set (set that avoids any arithmetic progressions of length 3) problem.
	\end{block}}

	\pause
	\begin{lemma}
		We prove that $ m = n^{1 - o(1)} $.
	\end{lemma}
\end{frame}
